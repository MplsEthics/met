...
class View(db.Model):
    ...
    Views are presented to the learner in a specific order.
    """
    path = db.StringProperty(verbose_name='view path')
    order = db.IntegerProperty(verbose_name='view order')
...
class Scenario(db.Model):
    ...
    prompt = db.StringProperty(required=False)
    prereq = db.StringProperty(required=False)
